...
declare void @llvm.riscv.th.vssb.nxv8i8.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>*,
  iXLen,
  iXLen);
...
; CHECK-NEXT:    th.vssb.v v8, (a0), a1
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssb.nxv8i8.nxv8i8(
...
declare void @llvm.riscv.th.vssb.mask.nxv8i8.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>*,
  iXLen,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a2, e8, m1, d1
; CHECK-NEXT:    th.vssb.v v8, (a0), a1, v0.t
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssb.mask.nxv8i8.nxv8i8(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i8>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vssb.nxv16i8.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssb.nxv16i8.nxv16i8(
...
declare void @llvm.riscv.th.vssb.mask.nxv16i8.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vssb.mask.nxv16i8.nxv16i8(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i8>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vssb.nxv32i8.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssb.nxv32i8.nxv32i8(
...
declare void @llvm.riscv.th.vssb.mask.nxv32i8.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>*,
  iXLen,
  <vscale x 32 x i1>,
...
entry:
  call void @llvm.riscv.th.vssb.mask.nxv32i8.nxv32i8(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i8>* %1,
    iXLen %2, 
    <vscale x 32 x i1> %3,
...
declare void @llvm.riscv.th.vssb.nxv64i8.nxv64i8(
  <vscale x 64 x i8>,
  <vscale x 64 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssb.nxv64i8.nxv64i8(
...
declare void @llvm.riscv.th.vssb.mask.nxv64i8.nxv64i8(
  <vscale x 64 x i8>,
  <vscale x 64 x i8>*,
  iXLen,
  <vscale x 64 x i1>,
...
entry:
  call void @llvm.riscv.th.vssb.mask.nxv64i8.nxv64i8(
    <vscale x 64 x i8> %0,
    <vscale x 64 x i8>* %1,
    iXLen %2, 
    <vscale x 64 x i1> %3,
...
declare void @llvm.riscv.th.vssh.nxv4i16.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>*,
  iXLen,
  iXLen);
...
; CHECK-NEXT:    th.vssh.v v8, (a0), a1
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssh.nxv4i16.nxv4i16(
...
declare void @llvm.riscv.th.vssh.mask.nxv4i16.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>*,
  iXLen,
  <vscale x 4 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a2, e16, m1, d1
; CHECK-NEXT:    th.vssh.v v8, (a0), a1, v0.t
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssh.mask.nxv4i16.nxv4i16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i16>* %1,
    iXLen %2, 
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vssh.nxv8i16.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssh.nxv8i16.nxv8i16(
...
declare void @llvm.riscv.th.vssh.mask.nxv8i16.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vssh.mask.nxv8i16.nxv8i16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i16>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vssh.nxv16i16.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssh.nxv16i16.nxv16i16(
...
declare void @llvm.riscv.th.vssh.mask.nxv16i16.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vssh.mask.nxv16i16.nxv16i16(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i16>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vssh.nxv32i16.nxv32i16(
  <vscale x 32 x i16>,
  <vscale x 32 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssh.nxv32i16.nxv32i16(
...
declare void @llvm.riscv.th.vssh.mask.nxv32i16.nxv32i16(
  <vscale x 32 x i16>,
  <vscale x 32 x i16>*,
  iXLen,
  <vscale x 32 x i1>,
...
entry:
  call void @llvm.riscv.th.vssh.mask.nxv32i16.nxv32i16(
    <vscale x 32 x i16> %0,
    <vscale x 32 x i16>* %1,
    iXLen %2, 
    <vscale x 32 x i1> %3,
...
declare void @llvm.riscv.th.vssw.nxv2i32.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>*,
  iXLen,
  iXLen);
...
; CHECK-NEXT:    th.vssw.v v8, (a0), a1
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssw.nxv2i32.nxv2i32(
...
declare void @llvm.riscv.th.vssw.mask.nxv2i32.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>*,
  iXLen,
  <vscale x 2 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a2, e32, m1, d1
; CHECK-NEXT:    th.vssw.v v8, (a0), a1, v0.t
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vssw.mask.nxv2i32.nxv2i32(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i32>* %1,
    iXLen %2, 
    <vscale x 2 x i1> %3,
...
declare void @llvm.riscv.th.vssw.nxv4i32.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssw.nxv4i32.nxv4i32(
...
declare void @llvm.riscv.th.vssw.mask.nxv4i32.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vssw.mask.nxv4i32.nxv4i32(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i32>* %1,
    iXLen %2, 
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vssw.nxv8i32.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssw.nxv8i32.nxv8i32(
...
declare void @llvm.riscv.th.vssw.mask.nxv8i32.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vssw.mask.nxv8i32.nxv8i32(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i32>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vssw.nxv16i32.nxv16i32(
  <vscale x 16 x i32>,
  <vscale x 16 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vssw.nxv16i32.nxv16i32(
...
declare void @llvm.riscv.th.vssw.mask.nxv16i32.nxv16i32(
  <vscale x 16 x i32>,
  <vscale x 16 x i32>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vssw.mask.nxv16i32.nxv16i32(
    <vscale x 16 x i32> %0,
    <vscale x 16 x i32>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv8i8.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>*,
  iXLen,
  iXLen);
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a2, e8, m1, d1
; CHECK-NEXT:    th.vsse.v v8, (a0), a1
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vsse.nxv8i8.nxv8i8(
    <vscale x 8 x i8> undef,
    <vscale x 8 x i8>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv8i8.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>*,
  iXLen,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a2, e8, m1, d1
; CHECK-NEXT:    th.vsse.v v8, (a0), a1, v0.t
; CHECK-NEXT:    ret

entry:
  call void @llvm.riscv.th.vsse.mask.nxv8i8.nxv8i8(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i8>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv16i8.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv16i8.nxv16i8(
    <vscale x 16 x i8> undef,
    <vscale x 16 x i8>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv16i8.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv16i8.nxv16i8(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i8>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv32i8.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv32i8.nxv32i8(
    <vscale x 32 x i8> undef,
    <vscale x 32 x i8>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv32i8.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>*,
  iXLen,
  <vscale x 32 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv32i8.nxv32i8(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i8>* %1,
    iXLen %2, 
    <vscale x 32 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv64i8.nxv64i8(
  <vscale x 64 x i8>,
  <vscale x 64 x i8>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv64i8.nxv64i8(
    <vscale x 64 x i8> undef,
    <vscale x 64 x i8>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv64i8.nxv64i8(
  <vscale x 64 x i8>,
  <vscale x 64 x i8>*,
  iXLen,
  <vscale x 64 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv64i8.nxv64i8(
    <vscale x 64 x i8> %0,
    <vscale x 64 x i8>* %1,
    iXLen %2, 
    <vscale x 64 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv4i16.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4i16.nxv4i16(
    <vscale x 4 x i16> undef,
    <vscale x 4 x i16>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv4i16.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4i16.nxv4i16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i16>* %1,
    iXLen %2, 
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv4f16.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4f16.nxv4f16(
...
declare void @llvm.riscv.th.vsse.mask.nxv4f16.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4f16.nxv4f16(
    <vscale x 4 x half> %0,
    <vscale x 4 x half>* %1,
    iXLen %2,
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv8i16.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8i16.nxv8i16(
    <vscale x 8 x i16> undef,
    <vscale x 8 x i16>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv8i16.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8i16.nxv8i16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i16>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv8f16.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8f16.nxv8f16(
...
declare void @llvm.riscv.th.vsse.mask.nxv8f16.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8f16.nxv8f16(
    <vscale x 8 x half> %0,
    <vscale x 8 x half>* %1,
    iXLen %2,
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv16i16.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv16i16.nxv16i16(
    <vscale x 16 x i16> undef,
    <vscale x 16 x i16>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv16i16.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv16i16.nxv16i16(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i16>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv16f16.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv16f16.nxv16f16(
...
declare void @llvm.riscv.th.vsse.mask.nxv16f16.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv16f16.nxv16f16(
    <vscale x 16 x half> %0,
...
declare void @llvm.riscv.th.vsse.nxv32i16.nxv32i16(
  <vscale x 32 x i16>,
  <vscale x 32 x i16>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv32i16.nxv32i16(
    <vscale x 32 x i16> undef,
    <vscale x 32 x i16>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv32i16.nxv32i16(
  <vscale x 32 x i16>,
  <vscale x 32 x i16>*,
  iXLen,
  <vscale x 32 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv32i16.nxv32i16(
    <vscale x 32 x i16> %0,
    <vscale x 32 x i16>* %1,
    iXLen %2, 
    <vscale x 32 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv32f16.nxv32f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv32f16.nxv32f16(
...
declare void @llvm.riscv.th.vsse.mask.nxv32f16.nxv32f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>*,
  iXLen,
  <vscale x 32 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv32f16.nxv32f16(
    <vscale x 32 x half> %0,
...
declare void @llvm.riscv.th.vsse.nxv2i32.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv2i32.nxv2i32(
    <vscale x 2 x i32> undef,
    <vscale x 2 x i32>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv2i32.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>*,
  iXLen,
  <vscale x 2 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv2i32.nxv2i32(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i32>* %1,
    iXLen %2, 
    <vscale x 2 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv2f32.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv2f32.nxv2f32(
...
declare void @llvm.riscv.th.vsse.mask.nxv2f32.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>*,
  iXLen,
  <vscale x 2 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv2f32.nxv2f32(
    <vscale x 2 x float> %0,
...
declare void @llvm.riscv.th.vsse.nxv4i32.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4i32.nxv4i32(
    <vscale x 4 x i32> undef,
    <vscale x 4 x i32>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv4i32.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4i32.nxv4i32(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i32>* %1,
    iXLen %2, 
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv4f32.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4f32.nxv4f32(
...
declare void @llvm.riscv.th.vsse.mask.nxv4f32.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4f32.nxv4f32(
    <vscale x 4 x float> %0,
...
declare void @llvm.riscv.th.vsse.nxv8i32.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8i32.nxv8i32(
    <vscale x 8 x i32> undef,
    <vscale x 8 x i32>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv8i32.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8i32.nxv8i32(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i32>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv8f32.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8f32.nxv8f32(
...
declare void @llvm.riscv.th.vsse.mask.nxv8f32.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8f32.nxv8f32(
    <vscale x 8 x float> %0,
...
declare void @llvm.riscv.th.vsse.nxv16i32.nxv16i32(
  <vscale x 16 x i32>,
  <vscale x 16 x i32>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv16i32.nxv16i32(
    <vscale x 16 x i32> undef,
    <vscale x 16 x i32>* %0,
    iXLen %1,
    iXLen %2)
...
declare void @llvm.riscv.th.vsse.mask.nxv16i32.nxv16i32(
  <vscale x 16 x i32>,
  <vscale x 16 x i32>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv16i32.nxv16i32(
    <vscale x 16 x i32> %0,
    <vscale x 16 x i32>* %1,
    iXLen %2, 
    <vscale x 16 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv16f32.nxv16f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv16f32.nxv16f32(
...
declare void @llvm.riscv.th.vsse.mask.nxv16f32.nxv16f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>*,
  iXLen,
  <vscale x 16 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv16f32.nxv16f32(
    <vscale x 16 x float> %0,
...
declare void @llvm.riscv.th.vsse.nxv1i64.nxv1i64(
  <vscale x 1 x i64>,
  <vscale x 1 x i64>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv1i64.nxv1i64(
...
declare void @llvm.riscv.th.vsse.mask.nxv1i64.nxv1i64(
  <vscale x 1 x i64>,
  <vscale x 1 x i64>*,
  iXLen,
  <vscale x 1 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv1i64.nxv1i64(
    <vscale x 1 x i64> %0,
    <vscale x 1 x i64>* %1,
    iXLen %2, 
    <vscale x 1 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv1f64.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv1f64.nxv1f64(
...
declare void @llvm.riscv.th.vsse.mask.nxv1f64.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>*,
  iXLen,
  <vscale x 1 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv1f64.nxv1f64(
    <vscale x 1 x double> %0,
...
declare void @llvm.riscv.th.vsse.nxv2i64.nxv2i64(
  <vscale x 2 x i64>,
  <vscale x 2 x i64>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv2i64.nxv2i64(
...
declare void @llvm.riscv.th.vsse.mask.nxv2i64.nxv2i64(
  <vscale x 2 x i64>,
  <vscale x 2 x i64>*,
  iXLen,
  <vscale x 2 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv2i64.nxv2i64(
    <vscale x 2 x i64> %0,
    <vscale x 2 x i64>* %1,
    iXLen %2, 
    <vscale x 2 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv2f64.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv2f64.nxv2f64(
...
declare void @llvm.riscv.th.vsse.mask.nxv2f64.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>*,
  iXLen,
  <vscale x 2 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv2f64.nxv2f64(
    <vscale x 2 x double> %0,
...
declare void @llvm.riscv.th.vsse.nxv4i64.nxv4i64(
  <vscale x 4 x i64>,
  <vscale x 4 x i64>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4i64.nxv4i64(
...
declare void @llvm.riscv.th.vsse.mask.nxv4i64.nxv4i64(
  <vscale x 4 x i64>,
  <vscale x 4 x i64>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4i64.nxv4i64(
    <vscale x 4 x i64> %0,
    <vscale x 4 x i64>* %1,
    iXLen %2, 
    <vscale x 4 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv4f64.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv4f64.nxv4f64(
...
declare void @llvm.riscv.th.vsse.mask.nxv4f64.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>*,
  iXLen,
  <vscale x 4 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv4f64.nxv4f64(
    <vscale x 4 x double> %0,
...
declare void @llvm.riscv.th.vsse.nxv8i64.nxv8i64(
  <vscale x 8 x i64>,
  <vscale x 8 x i64>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8i64.nxv8i64(
...
declare void @llvm.riscv.th.vsse.mask.nxv8i64.nxv8i64(
  <vscale x 8 x i64>,
  <vscale x 8 x i64>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8i64.nxv8i64(
    <vscale x 8 x i64> %0,
    <vscale x 8 x i64>* %1,
    iXLen %2, 
    <vscale x 8 x i1> %3,
...
declare void @llvm.riscv.th.vsse.nxv8f64.nxv8f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>*,
  iXLen,
  iXLen);
...
entry:
  call void @llvm.riscv.th.vsse.nxv8f64.nxv8f64(
...
declare void @llvm.riscv.th.vsse.mask.nxv8f64.nxv8f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>*,
  iXLen,
  <vscale x 8 x i1>,
...
entry:
  call void @llvm.riscv.th.vsse.mask.nxv8f64.nxv8f64(
    <vscale x 8 x double> %0,
