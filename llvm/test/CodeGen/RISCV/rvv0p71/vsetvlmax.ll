...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e8, m1, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e8, m2, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e8, m4, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e8, m8, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e16, m1, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e16, m2, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e16, m4, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e16, m8, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e64, m1, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e64, m2, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e64, m4, d1
; CHECK-NEXT:    ret
entry:
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli a0, zero, e64, m8, d1
; CHECK-NEXT:    ret
entry:
