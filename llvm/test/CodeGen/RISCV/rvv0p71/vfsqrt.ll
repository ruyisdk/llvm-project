...
declare <vscale x 4 x half> @llvm.riscv.th.vfsqrt.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vfsqrt.v v8, v8
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vfsqrt.nxv4f16(
...
declare <vscale x 4 x half> @llvm.riscv.th.vfsqrt.mask.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m1, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfsqrt.v v8, v9, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vfsqrt.mask.nxv4f16(
    <vscale x 4 x half> %0,
    <vscale x 4 x half> %1,
    <vscale x 4 x i1> %2,
    iXLen 0, iXLen %3)
...
declare <vscale x 8 x half> @llvm.riscv.th.vfsqrt.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vfsqrt.nxv8f16(
...
declare <vscale x 8 x half> @llvm.riscv.th.vfsqrt.mask.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m2, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfsqrt.v v8, v10, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vfsqrt.mask.nxv8f16(
    <vscale x 8 x half> %0,
    <vscale x 8 x half> %1,
    <vscale x 8 x i1> %2,
    iXLen 0, iXLen %3)
...
declare <vscale x 16 x half> @llvm.riscv.th.vfsqrt.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vfsqrt.nxv16f16(
...
declare <vscale x 16 x half> @llvm.riscv.th.vfsqrt.mask.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  <vscale x 16 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m4, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfsqrt.v v8, v12, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vfsqrt.mask.nxv16f16(
    <vscale x 16 x half> %0,
...
declare <vscale x 32 x half> @llvm.riscv.th.vfsqrt.nxv32f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x half> @llvm.riscv.th.vfsqrt.nxv32f16(
...
declare <vscale x 32 x half> @llvm.riscv.th.vfsqrt.mask.nxv32f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>,
  <vscale x 32 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m8, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfsqrt.v v8, v16, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x half> @llvm.riscv.th.vfsqrt.mask.nxv32f16(
    <vscale x 32 x half> %0,
...
declare <vscale x 2 x float> @llvm.riscv.th.vfsqrt.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vfsqrt.nxv2f32(
...
declare <vscale x 2 x float> @llvm.riscv.th.vfsqrt.mask.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  <vscale x 2 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vfsqrt.mask.nxv2f32(
    <vscale x 2 x float> %0,
...
declare <vscale x 4 x float> @llvm.riscv.th.vfsqrt.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vfsqrt.nxv4f32(
...
declare <vscale x 4 x float> @llvm.riscv.th.vfsqrt.mask.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vfsqrt.mask.nxv4f32(
    <vscale x 4 x float> %0,
...
declare <vscale x 8 x float> @llvm.riscv.th.vfsqrt.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vfsqrt.nxv8f32(
...
declare <vscale x 8 x float> @llvm.riscv.th.vfsqrt.mask.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vfsqrt.mask.nxv8f32(
    <vscale x 8 x float> %0,
...
declare <vscale x 16 x float> @llvm.riscv.th.vfsqrt.nxv16f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x float> @llvm.riscv.th.vfsqrt.nxv16f32(
...
declare <vscale x 16 x float> @llvm.riscv.th.vfsqrt.mask.nxv16f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>,
  <vscale x 16 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x float> @llvm.riscv.th.vfsqrt.mask.nxv16f32(
    <vscale x 16 x float> %0,
...
declare <vscale x 1 x double> @llvm.riscv.th.vfsqrt.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vfsqrt.nxv1f64(
...
declare <vscale x 1 x double> @llvm.riscv.th.vfsqrt.mask.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  <vscale x 1 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vfsqrt.mask.nxv1f64(
    <vscale x 1 x double> %0,
...
declare <vscale x 2 x double> @llvm.riscv.th.vfsqrt.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vfsqrt.nxv2f64(
...
declare <vscale x 2 x double> @llvm.riscv.th.vfsqrt.mask.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  <vscale x 2 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vfsqrt.mask.nxv2f64(
    <vscale x 2 x double> %0,
...
declare <vscale x 4 x double> @llvm.riscv.th.vfsqrt.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vfsqrt.nxv4f64(
...
declare <vscale x 4 x double> @llvm.riscv.th.vfsqrt.mask.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vfsqrt.mask.nxv4f64(
    <vscale x 4 x double> %0,
...
declare <vscale x 8 x double> @llvm.riscv.th.vfsqrt.nxv8f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x double> @llvm.riscv.th.vfsqrt.nxv8f64(
...
declare <vscale x 8 x double> @llvm.riscv.th.vfsqrt.mask.nxv8f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x double> @llvm.riscv.th.vfsqrt.mask.nxv8f64(
    <vscale x 8 x double> %0,
