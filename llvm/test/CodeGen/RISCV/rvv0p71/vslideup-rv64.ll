...
declare <vscale x 8 x i8> @llvm.riscv.th.vslideup.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>,
  i64,
  i64
...
; CHECK-NEXT:    th.vslideup.vx v8, v9, a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vslideup.nxv8i8(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i8> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 8 x i8> @llvm.riscv.th.vslideup.mask.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i8>,
  i64,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m1, d1
; CHECK-NEXT:    th.vslideup.vx v8, v9, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vslideup.mask.nxv8i8(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i8> %1,
    i64 %2,
    <vscale x 8 x i1> %3,
...
; CHECK-NEXT:    th.vslideup.vi v8, v9, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vslideup.nxv8i8(
    <vscale x 8 x i8> %0,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m1, d1
; CHECK-NEXT:    th.vslideup.vi v8, v9, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vslideup.mask.nxv8i8(
    <vscale x 8 x i8> %0,
...
declare <vscale x 16 x i8> @llvm.riscv.th.vslideup.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>,
  i64,
  i64
...
; CHECK-NEXT:    th.vslideup.vx v8, v10, a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vslideup.nxv16i8(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i8> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 16 x i8> @llvm.riscv.th.vslideup.mask.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i8>,
  i64,
  <vscale x 16 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m2, d1
; CHECK-NEXT:    th.vslideup.vx v8, v10, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vslideup.mask.nxv16i8(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i8> %1,
    i64 %2,
    <vscale x 16 x i1> %3,
...
; CHECK-NEXT:    th.vslideup.vi v8, v10, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vslideup.nxv16i8(
    <vscale x 16 x i8> %0,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m2, d1
; CHECK-NEXT:    th.vslideup.vi v8, v10, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vslideup.mask.nxv16i8(
    <vscale x 16 x i8> %0,
...
declare <vscale x 32 x i8> @llvm.riscv.th.vslideup.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>,
  i64,
  i64
...
; CHECK-NEXT:    th.vslideup.vx v8, v12, a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vslideup.nxv32i8(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i8> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 32 x i8> @llvm.riscv.th.vslideup.mask.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i8>,
  i64,
  <vscale x 32 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m4, d1
; CHECK-NEXT:    th.vslideup.vx v8, v12, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vslideup.mask.nxv32i8(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i8> %1,
    i64 %2,
    <vscale x 32 x i1> %3,
...
; CHECK-NEXT:    th.vslideup.vi v8, v12, 9
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vslideup.nxv32i8(
    <vscale x 32 x i8> %0,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m4, d1
; CHECK-NEXT:    th.vslideup.vi v8, v12, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vslideup.mask.nxv32i8(
    <vscale x 32 x i8> %0,
...
declare <vscale x 4 x i16> @llvm.riscv.th.vslideup.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vslideup.nxv4i16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i16> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 4 x i16> @llvm.riscv.th.vslideup.mask.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i16>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vslideup.mask.nxv4i16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i16> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i16> @llvm.riscv.th.vslideup.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vslideup.nxv8i16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i16> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 8 x i16> @llvm.riscv.th.vslideup.mask.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i16>,
  i64,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vslideup.mask.nxv8i16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i16> %1,
    i64 %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i16> @llvm.riscv.th.vslideup.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vslideup.nxv16i16(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i16> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 16 x i16> @llvm.riscv.th.vslideup.mask.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i16>,
  i64,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vslideup.mask.nxv16i16(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i16> %1,
    i64 %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 2 x i32> @llvm.riscv.th.vslideup.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vslideup.nxv2i32(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i32> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 2 x i32> @llvm.riscv.th.vslideup.mask.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i32>,
  i64,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vslideup.mask.nxv2i32(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i32> %1,
    i64 %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vslideup.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vslideup.nxv4i32(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i32> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 4 x i32> @llvm.riscv.th.vslideup.mask.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i32>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vslideup.mask.nxv4i32(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i32> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vslideup.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vslideup.nxv8i32(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i32> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 8 x i32> @llvm.riscv.th.vslideup.mask.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i32>,
  i64,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vslideup.mask.nxv8i32(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i32> %1,
    i64 %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 1 x i64> @llvm.riscv.th.vslideup.nxv1i64(
  <vscale x 1 x i64>,
  <vscale x 1 x i64>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vslideup.nxv1i64(
    <vscale x 1 x i64> %0,
    <vscale x 1 x i64> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 1 x i64> @llvm.riscv.th.vslideup.mask.nxv1i64(
  <vscale x 1 x i64>,
  <vscale x 1 x i64>,
  i64,
  <vscale x 1 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vslideup.mask.nxv1i64(
    <vscale x 1 x i64> %0,
    <vscale x 1 x i64> %1,
    i64 %2,
    <vscale x 1 x i1> %3,
...
declare <vscale x 2 x i64> @llvm.riscv.th.vslideup.nxv2i64(
  <vscale x 2 x i64>,
  <vscale x 2 x i64>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vslideup.nxv2i64(
    <vscale x 2 x i64> %0,
    <vscale x 2 x i64> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 2 x i64> @llvm.riscv.th.vslideup.mask.nxv2i64(
  <vscale x 2 x i64>,
  <vscale x 2 x i64>,
  i64,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vslideup.mask.nxv2i64(
    <vscale x 2 x i64> %0,
    <vscale x 2 x i64> %1,
    i64 %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i64> @llvm.riscv.th.vslideup.nxv4i64(
  <vscale x 4 x i64>,
  <vscale x 4 x i64>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vslideup.nxv4i64(
    <vscale x 4 x i64> %0,
    <vscale x 4 x i64> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 4 x i64> @llvm.riscv.th.vslideup.mask.nxv4i64(
  <vscale x 4 x i64>,
  <vscale x 4 x i64>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vslideup.mask.nxv4i64(
    <vscale x 4 x i64> %0,
    <vscale x 4 x i64> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 4 x half> @llvm.riscv.th.vslideup.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vslideup.nxv4f16(
    <vscale x 4 x half> %0,
    <vscale x 4 x half> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 4 x half> @llvm.riscv.th.vslideup.mask.nxv4f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vslideup.mask.nxv4f16(
    <vscale x 4 x half> %0,
    <vscale x 4 x half> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x half> @llvm.riscv.th.vslideup.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vslideup.nxv8f16(
    <vscale x 8 x half> %0,
    <vscale x 8 x half> %1,
    i64 %2,
    i64 %3)
...
declare <vscale x 8 x half> @llvm.riscv.th.vslideup.mask.nxv8f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  i64,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vslideup.mask.nxv8f16(
    <vscale x 8 x half> %0,
    <vscale x 8 x half> %1,
    i64 %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x half> @llvm.riscv.th.vslideup.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vslideup.nxv16f16(
...
declare <vscale x 16 x half> @llvm.riscv.th.vslideup.mask.nxv16f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  i64,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vslideup.mask.nxv16f16(
    <vscale x 16 x half> %0,
    <vscale x 16 x half> %1,
    i64 %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 2 x float> @llvm.riscv.th.vslideup.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vslideup.nxv2f32(
...
declare <vscale x 2 x float> @llvm.riscv.th.vslideup.mask.nxv2f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  i64,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vslideup.mask.nxv2f32(
    <vscale x 2 x float> %0,
    <vscale x 2 x float> %1,
    i64 %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x float> @llvm.riscv.th.vslideup.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vslideup.nxv4f32(
...
declare <vscale x 4 x float> @llvm.riscv.th.vslideup.mask.nxv4f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vslideup.mask.nxv4f32(
    <vscale x 4 x float> %0,
    <vscale x 4 x float> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x float> @llvm.riscv.th.vslideup.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vslideup.nxv8f32(
...
declare <vscale x 8 x float> @llvm.riscv.th.vslideup.mask.nxv8f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  i64,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vslideup.mask.nxv8f32(
    <vscale x 8 x float> %0,
    <vscale x 8 x float> %1,
    i64 %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 1 x double> @llvm.riscv.th.vslideup.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vslideup.nxv1f64(
...
declare <vscale x 1 x double> @llvm.riscv.th.vslideup.mask.nxv1f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  i64,
  <vscale x 1 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vslideup.mask.nxv1f64(
    <vscale x 1 x double> %0,
    <vscale x 1 x double> %1,
    i64 %2,
    <vscale x 1 x i1> %3,
...
declare <vscale x 2 x double> @llvm.riscv.th.vslideup.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vslideup.nxv2f64(
...
declare <vscale x 2 x double> @llvm.riscv.th.vslideup.mask.nxv2f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  i64,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vslideup.mask.nxv2f64(
    <vscale x 2 x double> %0,
    <vscale x 2 x double> %1,
    i64 %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x double> @llvm.riscv.th.vslideup.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  i64,
  i64
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vslideup.nxv4f64(
...
declare <vscale x 4 x double> @llvm.riscv.th.vslideup.mask.nxv4f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  i64,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vslideup.mask.nxv4f64(
    <vscale x 4 x double> %0,
    <vscale x 4 x double> %1,
    i64 %2,
    <vscale x 4 x i1> %3,
