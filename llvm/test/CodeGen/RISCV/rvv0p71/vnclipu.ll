...
declare <vscale x 8 x i8> @llvm.riscv.th.vnclipu.nxv8i8.nxv8i16.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i16>,
  <vscale x 8 x i8>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vnclipu.vv v11, v8, v10
; CHECK-NEXT:    th.vmv.v.v v8, v11
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.nxv8i8.nxv8i16.nxv8i8(
...
declare <vscale x 8 x i8> @llvm.riscv.th.vnclipu.mask.nxv8i8.nxv8i16.nxv8i8(
  <vscale x 8 x i8>,
  <vscale x 8 x i16>,
  <vscale x 8 x i8>,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m1, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vv v8, v10, v9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.mask.nxv8i8.nxv8i16.nxv8i8(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i16> %1,
    <vscale x 8 x i8> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i8> @llvm.riscv.th.vnclipu.nxv16i8.nxv16i16.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i16>,
  <vscale x 16 x i8>,
  iXLen, iXLen);
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vv v14, v8, v12
; CHECK-NEXT:    th.vmv.v.v v8, v14
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.nxv16i8.nxv16i16.nxv16i8(
...
declare <vscale x 16 x i8> @llvm.riscv.th.vnclipu.mask.nxv16i8.nxv16i16.nxv16i8(
  <vscale x 16 x i8>,
  <vscale x 16 x i16>,
  <vscale x 16 x i8>,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m2, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vv v8, v12, v10, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.mask.nxv16i8.nxv16i16.nxv16i8(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i16> %1,
    <vscale x 16 x i8> %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 32 x i8> @llvm.riscv.th.vnclipu.nxv32i8.nxv32i16.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i16>,
  <vscale x 32 x i8>,
  iXLen, iXLen);
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vv v20, v8, v16
; CHECK-NEXT:    th.vmv.v.v v8, v20
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.nxv32i8.nxv32i16.nxv32i8(
...
declare <vscale x 32 x i8> @llvm.riscv.th.vnclipu.mask.nxv32i8.nxv32i16.nxv32i8(
  <vscale x 32 x i8>,
  <vscale x 32 x i16>,
  <vscale x 32 x i8>,
  <vscale x 32 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m4, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vv v8, v16, v12, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.mask.nxv32i8.nxv32i16.nxv32i8(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i16> %1,
    <vscale x 32 x i8> %2,
    <vscale x 32 x i1> %3,
...
declare <vscale x 4 x i16> @llvm.riscv.th.vnclipu.nxv4i16.nxv4i32.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i32>,
  <vscale x 4 x i16>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vnclipu.nxv4i16.nxv4i32.nxv4i16(
...
declare <vscale x 4 x i16> @llvm.riscv.th.vnclipu.mask.nxv4i16.nxv4i32.nxv4i16(
  <vscale x 4 x i16>,
  <vscale x 4 x i32>,
  <vscale x 4 x i16>,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vnclipu.mask.nxv4i16.nxv4i32.nxv4i16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i32> %1,
    <vscale x 4 x i16> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i16> @llvm.riscv.th.vnclipu.nxv8i16.nxv8i32.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i32>,
  <vscale x 8 x i16>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vnclipu.nxv8i16.nxv8i32.nxv8i16(
...
declare <vscale x 8 x i16> @llvm.riscv.th.vnclipu.mask.nxv8i16.nxv8i32.nxv8i16(
  <vscale x 8 x i16>,
  <vscale x 8 x i32>,
  <vscale x 8 x i16>,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vnclipu.mask.nxv8i16.nxv8i32.nxv8i16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i32> %1,
    <vscale x 8 x i16> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i16> @llvm.riscv.th.vnclipu.nxv16i16.nxv16i32.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i32>,
  <vscale x 16 x i16>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vnclipu.nxv16i16.nxv16i32.nxv16i16(
...
declare <vscale x 16 x i16> @llvm.riscv.th.vnclipu.mask.nxv16i16.nxv16i32.nxv16i16(
  <vscale x 16 x i16>,
  <vscale x 16 x i32>,
  <vscale x 16 x i16>,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vnclipu.mask.nxv16i16.nxv16i32.nxv16i16(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i32> %1,
    <vscale x 16 x i16> %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 2 x i32> @llvm.riscv.th.vnclipu.nxv2i32.nxv2i64.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  <vscale x 2 x i32>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vnclipu.nxv2i32.nxv2i64.nxv2i32(
...
declare <vscale x 2 x i32> @llvm.riscv.th.vnclipu.mask.nxv2i32.nxv2i64.nxv2i32(
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  <vscale x 2 x i32>,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vnclipu.mask.nxv2i32.nxv2i64.nxv2i32(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i64> %1,
    <vscale x 2 x i32> %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vnclipu.nxv4i32.nxv4i64.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  <vscale x 4 x i32>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vnclipu.nxv4i32.nxv4i64.nxv4i32(
...
declare <vscale x 4 x i32> @llvm.riscv.th.vnclipu.mask.nxv4i32.nxv4i64.nxv4i32(
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  <vscale x 4 x i32>,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vnclipu.mask.nxv4i32.nxv4i64.nxv4i32(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i64> %1,
    <vscale x 4 x i32> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vnclipu.nxv8i32.nxv8i64.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  <vscale x 8 x i32>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vnclipu.nxv8i32.nxv8i64.nxv8i32(
...
declare <vscale x 8 x i32> @llvm.riscv.th.vnclipu.mask.nxv8i32.nxv8i64.nxv8i32(
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  <vscale x 8 x i32>,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vnclipu.mask.nxv8i32.nxv8i64.nxv8i32(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i64> %1,
    <vscale x 8 x i32> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 8 x i8> @llvm.riscv.th.vnclipu.nxv8i8.nxv8i16(
  <vscale x 8 x i8>,
  <vscale x 8 x i16>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v10, v8, a0
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.nxv8i8.nxv8i16(
    <vscale x 8 x i8> undef,
    <vscale x 8 x i16> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 8 x i8> @llvm.riscv.th.vnclipu.mask.nxv8i8.nxv8i16(
  <vscale x 8 x i8>,
  <vscale x 8 x i16>,
  iXLen,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m1, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v8, v10, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.mask.nxv8i8.nxv8i16(
    <vscale x 8 x i8> %0,
    <vscale x 8 x i16> %1,
    iXLen %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i8> @llvm.riscv.th.vnclipu.nxv16i8.nxv16i16(
  <vscale x 16 x i8>,
  <vscale x 16 x i16>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v12, v8, a0
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.nxv16i8.nxv16i16(
    <vscale x 16 x i8> undef,
    <vscale x 16 x i16> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 16 x i8> @llvm.riscv.th.vnclipu.mask.nxv16i8.nxv16i16(
  <vscale x 16 x i8>,
  <vscale x 16 x i16>,
  iXLen,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m2, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v8, v12, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.mask.nxv16i8.nxv16i16(
    <vscale x 16 x i8> %0,
    <vscale x 16 x i16> %1,
    iXLen %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 32 x i8> @llvm.riscv.th.vnclipu.nxv32i8.nxv32i16(
  <vscale x 32 x i8>,
  <vscale x 32 x i16>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v16, v8, a0
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.nxv32i8.nxv32i16(
    <vscale x 32 x i8> undef,
    <vscale x 32 x i16> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 32 x i8> @llvm.riscv.th.vnclipu.mask.nxv32i8.nxv32i16(
  <vscale x 32 x i8>,
  <vscale x 32 x i16>,
  iXLen,
  <vscale x 32 x i1>,
...
; CHECK-NEXT:    th.vsetvli zero, a1, e8, m4, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vx v8, v16, a0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.mask.nxv32i8.nxv32i16(
    <vscale x 32 x i8> %0,
    <vscale x 32 x i16> %1,
    iXLen %2,
    <vscale x 32 x i1> %3,
...
declare <vscale x 4 x i16> @llvm.riscv.th.vnclipu.nxv4i16.nxv4i32(
  <vscale x 4 x i16>,
  <vscale x 4 x i32>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vnclipu.nxv4i16.nxv4i32(
    <vscale x 4 x i16> undef,
    <vscale x 4 x i32> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 4 x i16> @llvm.riscv.th.vnclipu.mask.nxv4i16.nxv4i32(
  <vscale x 4 x i16>,
  <vscale x 4 x i32>,
  iXLen,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vnclipu.mask.nxv4i16.nxv4i32(
    <vscale x 4 x i16> %0,
    <vscale x 4 x i32> %1,
    iXLen %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i16> @llvm.riscv.th.vnclipu.nxv8i16.nxv8i32(
  <vscale x 8 x i16>,
  <vscale x 8 x i32>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vnclipu.nxv8i16.nxv8i32(
    <vscale x 8 x i16> undef,
    <vscale x 8 x i32> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 8 x i16> @llvm.riscv.th.vnclipu.mask.nxv8i16.nxv8i32(
  <vscale x 8 x i16>,
  <vscale x 8 x i32>,
  iXLen,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vnclipu.mask.nxv8i16.nxv8i32(
    <vscale x 8 x i16> %0,
    <vscale x 8 x i32> %1,
    iXLen %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i16> @llvm.riscv.th.vnclipu.nxv16i16.nxv16i32(
  <vscale x 16 x i16>,
  <vscale x 16 x i32>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vnclipu.nxv16i16.nxv16i32(
    <vscale x 16 x i16> undef,
    <vscale x 16 x i32> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 16 x i16> @llvm.riscv.th.vnclipu.mask.nxv16i16.nxv16i32(
  <vscale x 16 x i16>,
  <vscale x 16 x i32>,
  iXLen,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vnclipu.mask.nxv16i16.nxv16i32(
    <vscale x 16 x i16> %0,
    <vscale x 16 x i32> %1,
    iXLen %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 2 x i32> @llvm.riscv.th.vnclipu.nxv2i32.nxv2i64(
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vnclipu.nxv2i32.nxv2i64(
    <vscale x 2 x i32> undef,
    <vscale x 2 x i64> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 2 x i32> @llvm.riscv.th.vnclipu.mask.nxv2i32.nxv2i64(
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  iXLen,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vnclipu.mask.nxv2i32.nxv2i64(
    <vscale x 2 x i32> %0,
    <vscale x 2 x i64> %1,
    iXLen %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vnclipu.nxv4i32.nxv4i64(
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vnclipu.nxv4i32.nxv4i64(
    <vscale x 4 x i32> undef,
    <vscale x 4 x i64> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 4 x i32> @llvm.riscv.th.vnclipu.mask.nxv4i32.nxv4i64(
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  iXLen,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vnclipu.mask.nxv4i32.nxv4i64(
    <vscale x 4 x i32> %0,
    <vscale x 4 x i64> %1,
    iXLen %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vnclipu.nxv8i32.nxv8i64(
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  iXLen, iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vnclipu.nxv8i32.nxv8i64(
    <vscale x 8 x i32> undef,
    <vscale x 8 x i64> %0,
    iXLen %1,
    iXLen 0, iXLen %2)
...
declare <vscale x 8 x i32> @llvm.riscv.th.vnclipu.mask.nxv8i32.nxv8i64(
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  iXLen,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vnclipu.mask.nxv8i32.nxv8i64(
    <vscale x 8 x i32> %0,
    <vscale x 8 x i64> %1,
    iXLen %2,
    <vscale x 8 x i1> %3,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m1, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v10, v8, 9
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.nxv8i8.nxv8i16(
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m1, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v8, v10, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i8> @llvm.riscv.th.vnclipu.mask.nxv8i8.nxv8i16(
    <vscale x 8 x i8> %0,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m2, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v12, v8, 9
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.nxv16i8.nxv16i16(
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m2, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v8, v12, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i8> @llvm.riscv.th.vnclipu.mask.nxv16i8.nxv16i16(
    <vscale x 16 x i8> %0,
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m4, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v16, v8, 9
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.nxv32i8.nxv32i16(
...
; CHECK-NEXT:    th.vsetvli zero, a0, e8, m4, d1
; CHECK-NEXT:    csrwi vxrm, 0
; CHECK-NEXT:    th.vnclipu.vi v8, v16, 9, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i8> @llvm.riscv.th.vnclipu.mask.nxv32i8.nxv32i16(
    <vscale x 32 x i8> %0,
