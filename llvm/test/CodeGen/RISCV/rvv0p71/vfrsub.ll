...
declare <vscale x 4 x half> @llvm.riscv.th.vfrsub.nxv4f16.f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  half,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vfrsub.vf v8, v8, fa0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vfrsub.nxv4f16.f16(
...
declare <vscale x 4 x half> @llvm.riscv.th.vfrsub.mask.nxv4f16.f16(
  <vscale x 4 x half>,
  <vscale x 4 x half>,
  half,
  <vscale x 4 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m1, d1
; CHECK-NEXT:    th.vfrsub.vf v8, v9, fa0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x half> @llvm.riscv.th.vfrsub.mask.nxv4f16.f16(
    <vscale x 4 x half> %0,
    <vscale x 4 x half> %1,
    half %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x half> @llvm.riscv.th.vfrsub.nxv8f16.f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  half,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vfrsub.nxv8f16.f16(
...
declare <vscale x 8 x half> @llvm.riscv.th.vfrsub.mask.nxv8f16.f16(
  <vscale x 8 x half>,
  <vscale x 8 x half>,
  half,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m2, d1
; CHECK-NEXT:    th.vfrsub.vf v8, v10, fa0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x half> @llvm.riscv.th.vfrsub.mask.nxv8f16.f16(
    <vscale x 8 x half> %0,
    <vscale x 8 x half> %1,
    half %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x half> @llvm.riscv.th.vfrsub.nxv16f16.f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  half,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vfrsub.nxv16f16.f16(
...
declare <vscale x 16 x half> @llvm.riscv.th.vfrsub.mask.nxv16f16.f16(
  <vscale x 16 x half>,
  <vscale x 16 x half>,
  half,
  <vscale x 16 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m4, d1
; CHECK-NEXT:    th.vfrsub.vf v8, v12, fa0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x half> @llvm.riscv.th.vfrsub.mask.nxv16f16.f16(
    <vscale x 16 x half> %0,
...
declare <vscale x 32 x half> @llvm.riscv.th.vfrsub.nxv32f16.f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>,
  half,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x half> @llvm.riscv.th.vfrsub.nxv32f16.f16(
...
declare <vscale x 32 x half> @llvm.riscv.th.vfrsub.mask.nxv32f16.f16(
  <vscale x 32 x half>,
  <vscale x 32 x half>,
  half,
  <vscale x 32 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m8, d1
; CHECK-NEXT:    th.vfrsub.vf v8, v16, fa0, v0.t
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x half> @llvm.riscv.th.vfrsub.mask.nxv32f16.f16(
    <vscale x 32 x half> %0,
...
declare <vscale x 2 x float> @llvm.riscv.th.vfrsub.nxv2f32.f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  float,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vfrsub.nxv2f32.f32(
...
declare <vscale x 2 x float> @llvm.riscv.th.vfrsub.mask.nxv2f32.f32(
  <vscale x 2 x float>,
  <vscale x 2 x float>,
  float,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x float> @llvm.riscv.th.vfrsub.mask.nxv2f32.f32(
    <vscale x 2 x float> %0,
...
declare <vscale x 4 x float> @llvm.riscv.th.vfrsub.nxv4f32.f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  float,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vfrsub.nxv4f32.f32(
...
declare <vscale x 4 x float> @llvm.riscv.th.vfrsub.mask.nxv4f32.f32(
  <vscale x 4 x float>,
  <vscale x 4 x float>,
  float,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x float> @llvm.riscv.th.vfrsub.mask.nxv4f32.f32(
    <vscale x 4 x float> %0,
...
declare <vscale x 8 x float> @llvm.riscv.th.vfrsub.nxv8f32.f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  float,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vfrsub.nxv8f32.f32(
...
declare <vscale x 8 x float> @llvm.riscv.th.vfrsub.mask.nxv8f32.f32(
  <vscale x 8 x float>,
  <vscale x 8 x float>,
  float,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x float> @llvm.riscv.th.vfrsub.mask.nxv8f32.f32(
    <vscale x 8 x float> %0,
...
declare <vscale x 16 x float> @llvm.riscv.th.vfrsub.nxv16f32.f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>,
  float,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x float> @llvm.riscv.th.vfrsub.nxv16f32.f32(
...
declare <vscale x 16 x float> @llvm.riscv.th.vfrsub.mask.nxv16f32.f32(
  <vscale x 16 x float>,
  <vscale x 16 x float>,
  float,
  <vscale x 16 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x float> @llvm.riscv.th.vfrsub.mask.nxv16f32.f32(
    <vscale x 16 x float> %0,
...
declare <vscale x 1 x double> @llvm.riscv.th.vfrsub.nxv1f64.f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  double,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vfrsub.nxv1f64.f64(
...
declare <vscale x 1 x double> @llvm.riscv.th.vfrsub.mask.nxv1f64.f64(
  <vscale x 1 x double>,
  <vscale x 1 x double>,
  double,
  <vscale x 1 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x double> @llvm.riscv.th.vfrsub.mask.nxv1f64.f64(
    <vscale x 1 x double> %0,
...
declare <vscale x 2 x double> @llvm.riscv.th.vfrsub.nxv2f64.f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  double,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vfrsub.nxv2f64.f64(
...
declare <vscale x 2 x double> @llvm.riscv.th.vfrsub.mask.nxv2f64.f64(
  <vscale x 2 x double>,
  <vscale x 2 x double>,
  double,
  <vscale x 2 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x double> @llvm.riscv.th.vfrsub.mask.nxv2f64.f64(
    <vscale x 2 x double> %0,
...
declare <vscale x 4 x double> @llvm.riscv.th.vfrsub.nxv4f64.f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  double,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vfrsub.nxv4f64.f64(
...
declare <vscale x 4 x double> @llvm.riscv.th.vfrsub.mask.nxv4f64.f64(
  <vscale x 4 x double>,
  <vscale x 4 x double>,
  double,
  <vscale x 4 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x double> @llvm.riscv.th.vfrsub.mask.nxv4f64.f64(
    <vscale x 4 x double> %0,
...
declare <vscale x 8 x double> @llvm.riscv.th.vfrsub.nxv8f64.f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>,
  double,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x double> @llvm.riscv.th.vfrsub.nxv8f64.f64(
...
declare <vscale x 8 x double> @llvm.riscv.th.vfrsub.mask.nxv8f64.f64(
  <vscale x 8 x double>,
  <vscale x 8 x double>,
  double,
  <vscale x 8 x i1>,
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x double> @llvm.riscv.th.vfrsub.mask.nxv8f64.f64(
    <vscale x 8 x double> %0,
