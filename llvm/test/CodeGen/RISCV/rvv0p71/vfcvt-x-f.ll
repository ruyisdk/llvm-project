...
declare <vscale x 4 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv4i16.nxv4f16(
  <vscale x 4 x i16>,
  <vscale x 4 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vfcvt.x.f.v v8, v8
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv4i16.nxv4f16(
...
declare <vscale x 4 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i16.nxv4f16(
  <vscale x 4 x i16>,
  <vscale x 4 x half>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m1, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfcvt.x.f.v v8, v9, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i16.nxv4f16(
    <vscale x 4 x i16> %0,
    <vscale x 4 x half> %1,
    <vscale x 4 x i1> %2,
    iXLen 0, iXLen %3)
...
declare <vscale x 8 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv8i16.nxv8f16(
  <vscale x 8 x i16>,
  <vscale x 8 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv8i16.nxv8f16(
...
declare <vscale x 8 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i16.nxv8f16(
  <vscale x 8 x i16>,
  <vscale x 8 x half>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m2, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfcvt.x.f.v v8, v10, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i16.nxv8f16(
    <vscale x 8 x i16> %0,
    <vscale x 8 x half> %1,
    <vscale x 8 x i1> %2,
    iXLen 0, iXLen %3)
...
declare <vscale x 16 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv16i16.nxv16f16(
  <vscale x 16 x i16>,
  <vscale x 16 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv16i16.nxv16f16(
...
declare <vscale x 16 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv16i16.nxv16f16(
  <vscale x 16 x i16>,
  <vscale x 16 x half>,
  <vscale x 16 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m4, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfcvt.x.f.v v8, v12, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv16i16.nxv16f16(
    <vscale x 16 x i16> %0,
...
declare <vscale x 32 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv32i16.nxv32f16(
  <vscale x 32 x i16>,
  <vscale x 32 x half>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i16> @llvm.riscv.th.vfcvt.x.f.v.nxv32i16.nxv32f16(
...
declare <vscale x 32 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv32i16.nxv32f16(
  <vscale x 32 x i16>,
  <vscale x 32 x half>,
  <vscale x 32 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    th.vsetvli zero, a0, e16, m8, d1
; CHECK-NEXT:    fsrmi a0, 0
; CHECK-NEXT:    th.vfcvt.x.f.v v8, v16, v0.t
; CHECK-NEXT:    fsrm a0
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 32 x i16> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv32i16.nxv32f16(
    <vscale x 32 x i16> %0,
...
declare <vscale x 2 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv2i32.nxv2f32(
  <vscale x 2 x i32>,
  <vscale x 2 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv2i32.nxv2f32(
...
declare <vscale x 2 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv2i32.nxv2f32(
  <vscale x 2 x i32>,
  <vscale x 2 x float>,
  <vscale x 2 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv2i32.nxv2f32(
    <vscale x 2 x i32> %0,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv4i32.nxv4f32(
  <vscale x 4 x i32>,
  <vscale x 4 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv4i32.nxv4f32(
...
declare <vscale x 4 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i32.nxv4f32(
  <vscale x 4 x i32>,
  <vscale x 4 x float>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i32.nxv4f32(
    <vscale x 4 x i32> %0,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv8i32.nxv8f32(
  <vscale x 8 x i32>,
  <vscale x 8 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv8i32.nxv8f32(
...
declare <vscale x 8 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i32.nxv8f32(
  <vscale x 8 x i32>,
  <vscale x 8 x float>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i32.nxv8f32(
    <vscale x 8 x i32> %0,
...
declare <vscale x 16 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv16i32.nxv16f32(
  <vscale x 16 x i32>,
  <vscale x 16 x float>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i32> @llvm.riscv.th.vfcvt.x.f.v.nxv16i32.nxv16f32(
...
declare <vscale x 16 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv16i32.nxv16f32(
  <vscale x 16 x i32>,
  <vscale x 16 x float>,
  <vscale x 16 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 16 x i32> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv16i32.nxv16f32(
    <vscale x 16 x i32> %0,
...
declare <vscale x 1 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv1i64.nxv1f64(
  <vscale x 1 x i64>,
  <vscale x 1 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv1i64.nxv1f64(
...
declare <vscale x 1 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv1i64.nxv1f64(
  <vscale x 1 x i64>,
  <vscale x 1 x double>,
  <vscale x 1 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv1i64.nxv1f64(
    <vscale x 1 x i64> %0,
...
declare <vscale x 2 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv2i64.nxv2f64(
  <vscale x 2 x i64>,
  <vscale x 2 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv2i64.nxv2f64(
...
declare <vscale x 2 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv2i64.nxv2f64(
  <vscale x 2 x i64>,
  <vscale x 2 x double>,
  <vscale x 2 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv2i64.nxv2f64(
    <vscale x 2 x i64> %0,
...
declare <vscale x 4 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv4i64.nxv4f64(
  <vscale x 4 x i64>,
  <vscale x 4 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv4i64.nxv4f64(
...
declare <vscale x 4 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i64.nxv4f64(
  <vscale x 4 x i64>,
  <vscale x 4 x double>,
  <vscale x 4 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv4i64.nxv4f64(
    <vscale x 4 x i64> %0,
...
declare <vscale x 8 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv8i64.nxv8f64(
  <vscale x 8 x i64>,
  <vscale x 8 x double>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vfcvt.x.f.v.nxv8i64.nxv8f64(
...
declare <vscale x 8 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i64.nxv8f64(
  <vscale x 8 x i64>,
  <vscale x 8 x double>,
  <vscale x 8 x i1>,
  iXLen, iXLen);
...
; CHECK-NEXT:    ret
entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vfcvt.x.f.v.mask.nxv8i64.nxv8f64(
    <vscale x 8 x i64> %0,
