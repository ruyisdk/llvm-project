...
; CHECK-NEXT:    th.vamoaddw.v v9, v8, (a0), v9
; CHECK-NEXT:    th.vmv.v.v v8, v9
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vamoadd.nxv2i32.nxv2i32(
    <vscale x 2 x i32>* %0,
    <vscale x 2 x i32> %1,
    <vscale x 2 x i32> %2,
    iXLen %3)
...
declare <vscale x 2 x i32> @llvm.riscv.th.vamoadd.mask.nxv2i32.nxv2i32(
  <vscale x 2 x i32>*,
  <vscale x 2 x i32>,
  <vscale x 2 x i32>,
  <vscale x 2 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e32, m1, d1
; CHECK-NEXT:    th.vamoaddw.v v9, v8, (a0), v9, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v9
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vamoadd.mask.nxv2i32.nxv2i32(
    <vscale x 2 x i32>* %0,
    <vscale x 2 x i32> %1,
    <vscale x 2 x i32> %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vamoadd.nxv4i32.nxv4i32(
  <vscale x 4 x i32>*,
  <vscale x 4 x i32>,
  <vscale x 4 x i32>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddw.v v10, v8, (a0), v10
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vamoadd.nxv4i32.nxv4i32(
    <vscale x 4 x i32>* %0,
    <vscale x 4 x i32> %1,
    <vscale x 4 x i32> %2,
    iXLen %3)
...
declare <vscale x 4 x i32> @llvm.riscv.th.vamoadd.mask.nxv4i32.nxv4i32(
  <vscale x 4 x i32>*,
  <vscale x 4 x i32>,
  <vscale x 4 x i32>,
  <vscale x 4 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e32, m2, d1
; CHECK-NEXT:    th.vamoaddw.v v10, v8, (a0), v10, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vamoadd.mask.nxv4i32.nxv4i32(
    <vscale x 4 x i32>* %0,
    <vscale x 4 x i32> %1,
    <vscale x 4 x i32> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vamoadd.nxv8i32.nxv8i32(
  <vscale x 8 x i32>*,
  <vscale x 8 x i32>,
  <vscale x 8 x i32>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddw.v v12, v8, (a0), v12
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vamoadd.nxv8i32.nxv8i32(
    <vscale x 8 x i32>* %0,
    <vscale x 8 x i32> %1,
    <vscale x 8 x i32> %2,
    iXLen %3)
...
declare <vscale x 8 x i32> @llvm.riscv.th.vamoadd.mask.nxv8i32.nxv8i32(
  <vscale x 8 x i32>*,
  <vscale x 8 x i32>,
  <vscale x 8 x i32>,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e32, m4, d1
; CHECK-NEXT:    th.vamoaddw.v v12, v8, (a0), v12, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vamoadd.mask.nxv8i32.nxv8i32(
    <vscale x 8 x i32>* %0,
    <vscale x 8 x i32> %1,
    <vscale x 8 x i32> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 16 x i32> @llvm.riscv.th.vamoadd.nxv16i32.nxv16i32(
  <vscale x 16 x i32>*,
  <vscale x 16 x i32>,
  <vscale x 16 x i32>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddw.v v16, v8, (a0), v16
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 16 x i32> @llvm.riscv.th.vamoadd.nxv16i32.nxv16i32(
    <vscale x 16 x i32>* %0,
    <vscale x 16 x i32> %1,
    <vscale x 16 x i32> %2,
    iXLen %3)
...
declare <vscale x 16 x i32> @llvm.riscv.th.vamoadd.mask.nxv16i32.nxv16i32(
  <vscale x 16 x i32>*,
  <vscale x 16 x i32>,
  <vscale x 16 x i32>,
  <vscale x 16 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e32, m8, d1
; CHECK-NEXT:    th.vamoaddw.v v16, v8, (a0), v16, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 16 x i32> @llvm.riscv.th.vamoadd.mask.nxv16i32.nxv16i32(
    <vscale x 16 x i32>* %0,
    <vscale x 16 x i32> %1,
    <vscale x 16 x i32> %2,
    <vscale x 16 x i1> %3,
...
declare <vscale x 2 x i64> @llvm.riscv.th.vamoadd.nxv2i64.nxv2i32(
  <vscale x 2 x i64>*,
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddd.v v10, v8, (a0), v10
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vamoadd.nxv2i64.nxv2i32(
    <vscale x 2 x i64>* %0,
    <vscale x 2 x i32> %1,
    <vscale x 2 x i64> %2,
    iXLen %3)
...
declare <vscale x 2 x i64> @llvm.riscv.th.vamoadd.mask.nxv2i64.nxv2i32(
  <vscale x 2 x i64>*,
  <vscale x 2 x i32>,
  <vscale x 2 x i64>,
  <vscale x 2 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e64, m2, d1
; CHECK-NEXT:    th.vamoaddd.v v10, v8, (a0), v10, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v10
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vamoadd.mask.nxv2i64.nxv2i32(
    <vscale x 2 x i64>* %0,
    <vscale x 2 x i32> %1,
    <vscale x 2 x i64> %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i64> @llvm.riscv.th.vamoadd.nxv4i64.nxv4i32(
  <vscale x 4 x i64>*,
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddd.v v12, v8, (a0), v12
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vamoadd.nxv4i64.nxv4i32(
    <vscale x 4 x i64>* %0,
    <vscale x 4 x i32> %1,
    <vscale x 4 x i64> %2,
    iXLen %3)
...
declare <vscale x 4 x i64> @llvm.riscv.th.vamoadd.mask.nxv4i64.nxv4i32(
  <vscale x 4 x i64>*,
  <vscale x 4 x i32>,
  <vscale x 4 x i64>,
  <vscale x 4 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e64, m4, d1
; CHECK-NEXT:    th.vamoaddd.v v12, v8, (a0), v12, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v12
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vamoadd.mask.nxv4i64.nxv4i32(
    <vscale x 4 x i64>* %0,
    <vscale x 4 x i32> %1,
    <vscale x 4 x i64> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i64> @llvm.riscv.th.vamoadd.nxv8i64.nxv8i32(
  <vscale x 8 x i64>*,
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddd.v v16, v8, (a0), v16
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vamoadd.nxv8i64.nxv8i32(
    <vscale x 8 x i64>* %0,
    <vscale x 8 x i32> %1,
    <vscale x 8 x i64> %2,
    iXLen %3)
...
declare <vscale x 8 x i64> @llvm.riscv.th.vamoadd.mask.nxv8i64.nxv8i32(
  <vscale x 8 x i64>*,
  <vscale x 8 x i32>,
  <vscale x 8 x i64>,
  <vscale x 8 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e64, m8, d1
; CHECK-NEXT:    th.vamoaddd.v v16, v8, (a0), v16, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v16
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vamoadd.mask.nxv8i64.nxv8i32(
    <vscale x 8 x i64>* %0,
    <vscale x 8 x i32> %1,
    <vscale x 8 x i64> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 2 x i32> @llvm.riscv.th.vamoadd.nxv2i32.nxv2i64(
  <vscale x 2 x i32>*,
  <vscale x 2 x i64>,
  <vscale x 2 x i32>,
  iXLen);
...
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vamoadd.nxv2i32.nxv2i64(
    <vscale x 2 x i32>* %0,
    <vscale x 2 x i64> %1,
    <vscale x 2 x i32> %2,
    iXLen %3)
...
declare <vscale x 2 x i32> @llvm.riscv.th.vamoadd.mask.nxv2i32.nxv2i64(
  <vscale x 2 x i32>*,
  <vscale x 2 x i64>,
  <vscale x 2 x i32>,
  <vscale x 2 x i1>,
...
entry:
  %a = call <vscale x 2 x i32> @llvm.riscv.th.vamoadd.mask.nxv2i32.nxv2i64(
    <vscale x 2 x i32>* %0,
    <vscale x 2 x i64> %1,
    <vscale x 2 x i32> %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i32> @llvm.riscv.th.vamoadd.nxv4i32.nxv4i64(
  <vscale x 4 x i32>*,
  <vscale x 4 x i64>,
  <vscale x 4 x i32>,
  iXLen);
...
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vamoadd.nxv4i32.nxv4i64(
    <vscale x 4 x i32>* %0,
    <vscale x 4 x i64> %1,
    <vscale x 4 x i32> %2,
    iXLen %3)
...
declare <vscale x 4 x i32> @llvm.riscv.th.vamoadd.mask.nxv4i32.nxv4i64(
  <vscale x 4 x i32>*,
  <vscale x 4 x i64>,
  <vscale x 4 x i32>,
  <vscale x 4 x i1>,
...
entry:
  %a = call <vscale x 4 x i32> @llvm.riscv.th.vamoadd.mask.nxv4i32.nxv4i64(
    <vscale x 4 x i32>* %0,
    <vscale x 4 x i64> %1,
    <vscale x 4 x i32> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i32> @llvm.riscv.th.vamoadd.nxv8i32.nxv8i64(
  <vscale x 8 x i32>*,
  <vscale x 8 x i64>,
  <vscale x 8 x i32>,
  iXLen);
...
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vamoadd.nxv8i32.nxv8i64(
    <vscale x 8 x i32>* %0,
    <vscale x 8 x i64> %1,
    <vscale x 8 x i32> %2,
    iXLen %3)
...
declare <vscale x 8 x i32> @llvm.riscv.th.vamoadd.mask.nxv8i32.nxv8i64(
  <vscale x 8 x i32>*,
  <vscale x 8 x i64>,
  <vscale x 8 x i32>,
  <vscale x 8 x i1>,
...
entry:
  %a = call <vscale x 8 x i32> @llvm.riscv.th.vamoadd.mask.nxv8i32.nxv8i64(
    <vscale x 8 x i32>* %0,
    <vscale x 8 x i64> %1,
    <vscale x 8 x i32> %2,
    <vscale x 8 x i1> %3,
...
declare <vscale x 1 x i64> @llvm.riscv.th.vamoadd.nxv1i64.nxv1i64(
  <vscale x 1 x i64>*,
  <vscale x 1 x i64>,
  <vscale x 1 x i64>,
  iXLen);
...
; CHECK-NEXT:    th.vamoaddd.v v9, v8, (a0), v9
; CHECK-NEXT:    th.vmv.v.v v8, v9
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vamoadd.nxv1i64.nxv1i64(
    <vscale x 1 x i64>* %0,
    <vscale x 1 x i64> %1,
    <vscale x 1 x i64> %2,
    iXLen %3)
...
declare <vscale x 1 x i64> @llvm.riscv.th.vamoadd.mask.nxv1i64.nxv1i64(
  <vscale x 1 x i64>*,
  <vscale x 1 x i64>,
  <vscale x 1 x i64>,
  <vscale x 1 x i1>,
...
; CHECK:       # %bb.0: # %entry
; CHECK-NEXT:    th.vsetvli zero, a1, e64, m1, d1
; CHECK-NEXT:    th.vamoaddd.v v9, v8, (a0), v9, v0.t
; CHECK-NEXT:    th.vmv.v.v v8, v9
; CHECK-NEXT:    ret

entry:
  %a = call <vscale x 1 x i64> @llvm.riscv.th.vamoadd.mask.nxv1i64.nxv1i64(
    <vscale x 1 x i64>* %0,
    <vscale x 1 x i64> %1,
    <vscale x 1 x i64> %2,
    <vscale x 1 x i1> %3,
...
declare <vscale x 2 x i64> @llvm.riscv.th.vamoadd.nxv2i64.nxv2i64(
  <vscale x 2 x i64>*,
  <vscale x 2 x i64>,
  <vscale x 2 x i64>,
  iXLen);
...
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vamoadd.nxv2i64.nxv2i64(
    <vscale x 2 x i64>* %0,
    <vscale x 2 x i64> %1,
    <vscale x 2 x i64> %2,
    iXLen %3)
...
declare <vscale x 2 x i64> @llvm.riscv.th.vamoadd.mask.nxv2i64.nxv2i64(
  <vscale x 2 x i64>*,
  <vscale x 2 x i64>,
  <vscale x 2 x i64>,
  <vscale x 2 x i1>,
...
entry:
  %a = call <vscale x 2 x i64> @llvm.riscv.th.vamoadd.mask.nxv2i64.nxv2i64(
    <vscale x 2 x i64>* %0,
    <vscale x 2 x i64> %1,
    <vscale x 2 x i64> %2,
    <vscale x 2 x i1> %3,
...
declare <vscale x 4 x i64> @llvm.riscv.th.vamoadd.nxv4i64.nxv4i64(
  <vscale x 4 x i64>*,
  <vscale x 4 x i64>,
  <vscale x 4 x i64>,
  iXLen);
...
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vamoadd.nxv4i64.nxv4i64(
    <vscale x 4 x i64>* %0,
    <vscale x 4 x i64> %1,
    <vscale x 4 x i64> %2,
    iXLen %3)
...
declare <vscale x 4 x i64> @llvm.riscv.th.vamoadd.mask.nxv4i64.nxv4i64(
  <vscale x 4 x i64>*,
  <vscale x 4 x i64>,
  <vscale x 4 x i64>,
  <vscale x 4 x i1>,
...
entry:
  %a = call <vscale x 4 x i64> @llvm.riscv.th.vamoadd.mask.nxv4i64.nxv4i64(
    <vscale x 4 x i64>* %0,
    <vscale x 4 x i64> %1,
    <vscale x 4 x i64> %2,
    <vscale x 4 x i1> %3,
...
declare <vscale x 8 x i64> @llvm.riscv.th.vamoadd.nxv8i64.nxv8i64(
  <vscale x 8 x i64>*,
  <vscale x 8 x i64>,
  <vscale x 8 x i64>,
  iXLen);
...
entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vamoadd.nxv8i64.nxv8i64(
    <vscale x 8 x i64>* %0,
    <vscale x 8 x i64> %1,
    <vscale x 8 x i64> %2,
    iXLen %3)
...
declare <vscale x 8 x i64> @llvm.riscv.th.vamoadd.mask.nxv8i64.nxv8i64(
  <vscale x 8 x i64>*,
  <vscale x 8 x i64>,
  <vscale x 8 x i64>,
  <vscale x 8 x i1>,
...
entry:
  %a = call <vscale x 8 x i64> @llvm.riscv.th.vamoadd.mask.nxv8i64.nxv8i64(
    <vscale x 8 x i64>* %0,
    <vscale x 8 x i64> %1,
    <vscale x 8 x i64> %2,
    <vscale x 8 x i1> %3,
