...
void RISCVDAGToDAGISel::addXTHeadVLoadStoreOperands(
    SDNode *Node, unsigned Log2SEW, const SDLoc &DL, unsigned CurOp, bool IsMasked,
...
void RISCVDAGToDAGISel::selectXVL(
  ...
  // We push passthru back to Operands.
  Operands.push_back(Node->getOperand(CurOp++));

  MVT IndexVT;
  addXTHeadVLoadStoreOperands(Node, Log2SEW, DL, CurOp, IsMasked,
                              IsStrided | IsIndexed, Operands, &IndexVT);
...
void RISCVDAGToDAGISel::selectXVS(
    SDNode *Node, const SDLoc& DL, unsigned IntNo, bool IsMasked,
...
#define CASE_TAG_TO_THVLSSEG_INTRINSIC(tag)  \
  case Intrinsic::riscv_th_vlsseg2##tag:     \
  case Intrinsic::riscv_th_vlsseg3##tag:     \
  case Intrinsic::riscv_th_vlsseg4##tag:     \
  case Intrinsic::riscv_th_vlsseg5##tag:     \
  case Intrinsic::riscv_th_vlsseg6##tag:     \
  case Intrinsic::riscv_th_vlsseg7##tag:     \
  case Intrinsic::riscv_th_vlsseg8##tag:

#define CASE_TAG_TO_THVLXSEG_INTRINSIC(tag)  \
  case Intrinsic::riscv_th_vlxseg2##tag:     \
  case Intrinsic::riscv_th_vlxseg3##tag:     \
  case Intrinsic::riscv_th_vlxseg4##tag:     \
  case Intrinsic::riscv_th_vlxseg5##tag:     \
...
void RISCVDAGToDAGISel::selectXVLSEG(SDNode *Node, unsigned IntNo, bool IsMasked,
                                     bool IsStrided, bool IsIndexed, bool IsFF,
  ...
  auto Tag2Log2MEM = [] (unsigned no) {
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(b)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(bu)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(bu_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(b)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(bu)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(bu_mask)
      return 3;
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(h)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(hu)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(hu_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(h)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(hu)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(hu_mask)
      return 4;
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(w)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(wu)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(w_mask)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(wu_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(w)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(wu)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(w_mask)
    CASE_TAG_TO_THVLXSEG_INTRINSIC(wu_mask)
      return 5;
    }
    llvm_unreachable("Impossible intrinsic tag");
  };
  ...
  const RISCV::TH_VLSEGPseudo *P =
      RISCV::getTH_VLSEGPseudo(NF, IsMasked, IsStrided, IsIndexed, IsFF, IsUnsigned,
                               IsE, Log2MEM, Log2SEW, static_cast<unsigned>(LMUL));
...
#define CASE_TAG_TO_THVSSSEG_INTRINSIC(tag) \
  case Intrinsic::riscv_th_vssseg2##tag:    \
  case Intrinsic::riscv_th_vssseg3##tag:    \
  case Intrinsic::riscv_th_vssseg4##tag:    \
  case Intrinsic::riscv_th_vssseg5##tag:    \
  case Intrinsic::riscv_th_vssseg6##tag:    \
  case Intrinsic::riscv_th_vssseg7##tag:    \
  case Intrinsic::riscv_th_vssseg8##tag:
...
void RISCVDAGToDAGISel::selectXVSSEG(SDNode *Node, unsigned IntNo, bool IsMasked,
                                     bool IsStrided, bool IsIndexed, bool IsE) {
  auto Tag2Log2MEM = [] (unsigned no) {
    switch (no) {
    CASE_TAG_TO_THVSSEG_INTRINSIC(b)
    CASE_TAG_TO_THVSSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVSSSEG_INTRINSIC(b)
    CASE_TAG_TO_THVSSSEG_INTRINSIC(b_mask)
  ...
  const RISCV::TH_VSSEGPseudo *P = RISCV::getTH_VSSEGPseudo(
      NF, IsMasked, IsStrided, IsIndexed, IsE,
      Log2MEM, Log2SEW, static_cast<unsigned>(LMUL));
  MachineSDNode *Store =
...
void RISCVDAGToDAGISel::selectXVSETVLI(SDNode *Node) {
  ...
  assert((IntNo == Intrinsic::riscv_th_vsetvlmax ||
          IntNo == Intrinsic::riscv_th_vsetvl) &&
  ...
  bool IsMax = IntNo == Intrinsic::riscv_th_vsetvlmax;
...
#undef CASE_VMXOR_VMANDN_VMOR_OPCODES
    ...
    case Intrinsic::riscv_th_vsetvl:
    case Intrinsic::riscv_th_vsetvlmax:
  ...
  case ISD::INTRINSIC_W_CHAIN: {
    ...
    CASE_TAG_TO_THVLSEG_INTRINSIC(h)
    CASE_TAG_TO_THVLSEG_INTRINSIC(w) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVLSEG_INTRINSIC(bu)
    ...
    CASE_TAG_TO_THVLSEG_INTRINSIC(wu) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ true,
                   /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVLSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVLSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVLSEG_INTRINSIC(w_mask) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ true, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(h)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(w) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVLSSEG_INTRINSIC(w_mask) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ true, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVLSSEG_INTRINSIC(e) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ true);
      return;
    }
    CASE_TAG_TO_THVLSSEG_INTRINSIC(e_mask) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ true, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ true);
      return;
    ...
    CASE_TAG_TO_THVLXSEG_INTRINSIC(w) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVLXSEG_INTRINSIC(bu)
    ...
    CASE_TAG_TO_THVLXSEG_INTRINSIC(wu) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsFF*/ false, /*IsUnsigned*/ true,
                   /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVLXSEG_INTRINSIC(b_mask)
    ...
    CASE_TAG_TO_THVLXSEG_INTRINSIC(e) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ true);
      return;
    }
    CASE_TAG_TO_THVLXSEG_INTRINSIC(e_mask) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ true, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsFF*/ false, /*IsUnsigned*/ false,
                   /*IsE*/ true);
      return;
    ...
    CASE_TAG_TO_THVLSEG_INTRINSIC(eff) {
      selectXVLSEG(Node, IntNo, /*IsMask*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsFF*/ true, /*IsUnsigned*/ false,
                   /*IsE*/ true);
      return;
    }
    ...
    case Intrinsic::riscv_th_vlxe_mask: {
      ...
      selectXVL(Node, DL, IntNo, /*IsUnsigned*/false, /*IsMasked*/true,
                /*IsStrided*/false, /*IsIndexed*/true, /*IsFF*/false,
                IntNo == Intrinsic::riscv_th_vlxe_mask);
      return;
    }
    case Intrinsic::riscv_th_vlxbu_mask:
    case Intrinsic::riscv_th_vlxhu_mask:
    ...
    case Intrinsic::riscv_th_vle: {
      ...
      selectXVL(Node, DL, IntNo, /*IsUnsigned*/ false, /*IsMasked*/ false,
                ...
                /*IsE*/ IntNo == Intrinsic::riscv_th_vle);
      return;
    }
    case Intrinsic::riscv_th_vlsb:
    case Intrinsic::riscv_th_vlsh:
    ...
    case Intrinsic::riscv_th_vlse: {
      ...
      selectXVL(Node, DL, IntNo, /*IsUnsigned*/ false, /*IsMasked*/ false,
                ...
                /*IsE*/ IntNo == Intrinsic::riscv_th_vlse);
      return;
    }
    case Intrinsic::riscv_th_vlbu:
    case Intrinsic::riscv_th_vlhu:
    ...
    case Intrinsic::riscv_th_vle_mask: {
      ...
      selectXVL(Node, DL, IntNo, /*IsUnsigned*/ false, /*IsMasked*/ true,
                /*IsStrided*/ false, /*IsIndexed*/ false, /*IsFF*/ false,
                /*IsE*/ IntNo == Intrinsic::riscv_th_vle_mask);
      return;
    }
    case Intrinsic::riscv_th_vlbu_mask:
    case Intrinsic::riscv_th_vlhu_mask:
    ...
    case Intrinsic::riscv_th_vlse_mask: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vlse_mask;
      selectXVL(Node, DL, IntNo, /*IsUnsigned*/ false, /*IsMasked*/ true,
  ...
  case ISD::INTRINSIC_VOID: {
    ...
    CASE_TAG_TO_THVSSEG_INTRINSIC(h)
    CASE_TAG_TO_THVSSEG_INTRINSIC(w) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVSSEG_INTRINSIC(e) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsE*/ true);
      return;
    }
    CASE_TAG_TO_THVSSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVSSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVSSEG_INTRINSIC(w_mask) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ true, /*IsStrided*/ false,
                   /*IsIndexed*/ false, /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVSSSEG_INTRINSIC(h)
    CASE_TAG_TO_THVSSSEG_INTRINSIC(w) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ false, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVSSSEG_INTRINSIC(h_mask)
    CASE_TAG_TO_THVSSSEG_INTRINSIC(w_mask) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ true, /*IsStrided*/ true,
                   /*IsIndexed*/ false, /*IsE*/ false);
      return;
    }
    ...
    CASE_TAG_TO_THVSXSEG_INTRINSIC(w) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsE*/ false);
      return;
    }
    CASE_TAG_TO_THVSXSEG_INTRINSIC(e) {
      selectXVSSEG(Node, IntNo, /*IsMasked*/ false, /*IsStrided*/ false,
                   /*IsIndexed*/ true, /*IsE*/ true);
      return;
    }
    CASE_TAG_TO_THVSXSEG_INTRINSIC(b_mask)
    CASE_TAG_TO_THVSXSEG_INTRINSIC(h_mask)
    ...
    case Intrinsic::riscv_th_vsxe: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vsxe;
      selectXVS(Node, DL, IntNo, /*IsMask*/ false,
                /*IsStrided*/ false, /*IsIndexed*/ true, IsE);
      return;
    }
    case Intrinsic::riscv_th_vsxb_mask:
    case Intrinsic::riscv_th_vsxh_mask:
    ...
    case Intrinsic::riscv_th_vsxe_mask: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vsxe_mask;
      selectXVS(Node, DL, IntNo, /*IsMask*/ true,
                /*IsStrided*/ false, /*IsIndexed*/ true, IsE);
      return;
    }
    ...
    case Intrinsic::riscv_th_vse: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vse;
      selectXVS(Node, DL, IntNo, /*IsMask*/ false,
                /*IsStrided*/ false, /*IsIndexed*/ false, IsE);
      return;
    }
    case Intrinsic::riscv_th_vssb:
    case Intrinsic::riscv_th_vssh:
    ...
    case Intrinsic::riscv_th_vsse: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vsse;
      selectXVS(Node, DL, IntNo, /*IsMask*/ false,
    ...
    case Intrinsic::riscv_th_vse_mask: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vse_mask;
      selectXVS(Node, DL, IntNo, /*IsMask*/ true,
                /*IsStrided*/ false, /*IsIndexed*/ false, IsE);
      return;
    }
    ...
    case Intrinsic::riscv_th_vsse_mask: {
      if (!Subtarget->hasVendorXTHeadV())
        return;
      bool IsE = IntNo == Intrinsic::riscv_th_vsse_mask;
      selectXVS(Node, DL, IntNo, /*IsMask*/ true,
                /*IsStrided*/ true, /*IsIndexed*/ false, IsE);
      return;
    }
