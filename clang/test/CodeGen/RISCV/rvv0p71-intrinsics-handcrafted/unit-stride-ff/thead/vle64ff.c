...
// CHECK-RV64-LABEL: define dso_local <vscale x 1 x double> @test_th_vle64ff_v_f64m1
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 1 x double>, i64 } @llvm.riscv.th.vleff.nxv1f64.i64(<vscale x 1 x double> poison, ptr [[BASE]], i64 [[VL]])
...
//
vfloat64m1_t test_th_vle64ff_v_f64m1(const float64_t *base, size_t *new_vl, size_t vl) {
  return __riscv_th_vle64ff_v_f64m1(base, new_vl, vl);
}

// CHECK-RV64-LABEL: define dso_local <vscale x 2 x double> @test_th_vle64ff_v_f64m2
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 2 x double>, i64 } @llvm.riscv.th.vleff.nxv2f64.i64(<vscale x 2 x double> poison, ptr [[BASE]], i64 [[VL]])
...
//
vfloat64m2_t test_th_vle64ff_v_f64m2(const float64_t *base, size_t *new_vl, size_t vl) {
  return __riscv_th_vle64ff_v_f64m2(base, new_vl, vl);
}

// CHECK-RV64-LABEL: define dso_local <vscale x 4 x double> @test_th_vle64ff_v_f64m4
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 4 x double>, i64 } @llvm.riscv.th.vleff.nxv4f64.i64(<vscale x 4 x double> poison, ptr [[BASE]], i64 [[VL]])
...
//
vfloat64m4_t test_th_vle64ff_v_f64m4(const float64_t *base, size_t *new_vl, size_t vl) {
  return __riscv_th_vle64ff_v_f64m4(base, new_vl, vl);
}

// CHECK-RV64-LABEL: define dso_local <vscale x 8 x double> @test_th_vle64ff_v_f64m8
// CHECK-RV64-SAME: (ptr noundef [[BASE:%.*]], ptr noundef [[NEW_VL:%.*]], i64 noundef [[VL:%.*]]) #[[ATTR0:[0-9]+]] {
// CHECK-RV64-NEXT:  entry:
// CHECK-RV64-NEXT:    [[TMP0:%.*]] = call { <vscale x 8 x double>, i64 } @llvm.riscv.th.vleff.nxv8f64.i64(<vscale x 8 x double> poison, ptr [[BASE]], i64 [[VL]])
...
//
vfloat64m8_t test_th_vle64ff_v_f64m8(const float64_t *base, size_t *new_vl, size_t vl) {
  return __riscv_th_vle64ff_v_f64m8(base, new_vl, vl);
}
