...
// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b1
...
unsigned long test_vpopc_m_b1(vbool1_t op1, size_t vl) {
  return __riscv_vpopc_m_b1(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b2
...
unsigned long test_vpopc_m_b2(vbool2_t op1, size_t vl) {
  return __riscv_vpopc_m_b2(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b4
...
unsigned long test_vpopc_m_b4(vbool4_t op1, size_t vl) {
  return __riscv_vpopc_m_b4(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b8
...
unsigned long test_vpopc_m_b8(vbool8_t op1, size_t vl) {
  return __riscv_vpopc_m_b8(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b16
...
unsigned long test_vpopc_m_b16(vbool16_t op1, size_t vl) {
  return __riscv_vpopc_m_b16(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b32
...
unsigned long test_vpopc_m_b32(vbool32_t op1, size_t vl) {
  return __riscv_vpopc_m_b32(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b64
...
unsigned long test_vpopc_m_b64(vbool64_t op1, size_t vl) {
  return __riscv_vpopc_m_b64(op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b1_m
...
unsigned long test_vpopc_m_b1_m(vbool1_t mask, vbool1_t op1, size_t vl) {
  return __riscv_vpopc_m_b1_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b2_m
...
unsigned long test_vpopc_m_b2_m(vbool2_t mask, vbool2_t op1, size_t vl) {
  return __riscv_vpopc_m_b2_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b4_m
...
unsigned long test_vpopc_m_b4_m(vbool4_t mask, vbool4_t op1, size_t vl) {
  return __riscv_vpopc_m_b4_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b8_m
...
unsigned long test_vpopc_m_b8_m(vbool8_t mask, vbool8_t op1, size_t vl) {
  return __riscv_vpopc_m_b8_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b16_m
...
unsigned long test_vpopc_m_b16_m(vbool16_t mask, vbool16_t op1, size_t vl) {
  return __riscv_vpopc_m_b16_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b32_m
...
unsigned long test_vpopc_m_b32_m(vbool32_t mask, vbool32_t op1, size_t vl) {
  return __riscv_vpopc_m_b32_m(mask, op1, vl);
}

// CHECK-RV64-LABEL: define dso_local i64 @test_vpopc_m_b64_m
...
unsigned long test_vpopc_m_b64_m(vbool64_t mask, vbool64_t op1, size_t vl) {
  return __riscv_vpopc_m_b64_m(mask, op1, vl);
}
